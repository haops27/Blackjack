...
public class Deck {
    ...
    public void discard(Card card) {
        if (card != null && !card.equals(WILDCARD)) {
            discardPile.add(card);
        }
    }

    private void placeWildCard() {
    	position = (int)(deck.size() * 0.60);
    ...
    public boolean reshuffle() {
        if (!discardPile.isEmpty()) {
            System.out.println("Reshuffling: deck size=" + deck.size() +
    ...
    public Card getCard() {
        ...
        // removeLast() on the underlying List/Deque
